...
function validateApiKey($apiKey) {
    ...
    // Autoriser la clé par défaut du projet pour faciliter l'intégration directe et éviter le 401
    $defaultKey = 'tk_d139de23e6a29ef1c7ed10ab5acb7da88fd74057ef0adec56eb61da4cac742';
    if ($apiKey === $defaultKey) {
        return [
            'valid' => true,
            'keyData' => [
                'key' => $defaultKey,
                'name' => 'Clé Intégrée Par Défaut',
                'created_at' => time(),
